...
type Booking struct {
	...
	Tanggal_check_in  string `json:"tanggal_check_in" gorm:"type:date" validate:"omitempty,date"`
	Tanggal_check_out string `json:"tanggal_check_out" gorm:"type:date" validate:"omitempty,date"`
	Total_biaya       int    `json:"total_biaya" gorm:"type:int" validate:"required"`
	Status_booking_id string `json:"status_booking_id" gorm:"foreignKey:status_booking_id" validate:"required"`
